...
router.post('/add', async (req, res) => {
    ...
    try {
        ...
        const result = await pool.query(`INSERT INTO songs ("name", "artist", "release_date", "length", "popularity", "danceability")  
        VALUES ($1, $2, $3, $4, $5, $6) RETURNING index`, [name, artist, release_date, length, popularity, danceability]);
        res.json({ insert: result.rows[0].index});
